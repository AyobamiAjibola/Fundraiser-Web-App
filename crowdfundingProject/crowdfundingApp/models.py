...
class Crowdfunding(models.Model):
    ...
    likes = models.ManyToManyField(User, related_name='liked_crowdfundings', blank=True)
    donations = models.ManyToManyField(Donation, related_name='crowdfunding_donations', blank=True)
    ...
    amountRaised = models.DecimalField(max_digits=10, decimal_places=2, null=True, blank=True)
...
class Transaction(models.Model):
    ...
    user = models.ForeignKey(User, on_delete=models.DO_NOTHING, related_name='transaction', null=True, blank=True)
